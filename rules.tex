...
\begin{document}
    ...
    \begin{mathpar}
        ...
        \inferrule{\Gamma;\Sigma_1\mid\Phi \vdash\mathrm{t_1}\colon\mathrm{T_1}\\ \Gamma;\Sigma_2\mid\Phi \vdash\mathrm{t_2}\colon\mathrm{T_2}}{\Gamma;\Sigma_1\cup\Sigma_2\mid\Phi \vdash\mathrm{fork}\ \mathrm{t_1}\ \mathrm{t_2}\colon\mathrm{T_1}\times\mathrm{T_2}}
    \end{mathpar}
